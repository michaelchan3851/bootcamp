...
public class DemoArrayList {
    public static void main(String[] args) {
        ...
        // integers [2] = "abc"; //compile-run error

        // Declaration
        ArrayList<Integer> numbers;
        // Initialization, create ArrayList object
        numbers = new ArrayList<>(); // if not declaration, will use defalut declaration
        ...
        // there have default toString, so print out values instead of object references

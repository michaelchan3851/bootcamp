...
public class JavaQuest12 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Case 1: [2,7,11,15] Target: 9 Ans: " + Arrays.toString(answers));
    System.out.println("Case 2: [3,2,4] Target: 6 Ans: " + Arrays.toString(answers2));
    System.out.println("Case 3: [3, 3] Target: 7 Ans:" + Arrays.toString(answers3));

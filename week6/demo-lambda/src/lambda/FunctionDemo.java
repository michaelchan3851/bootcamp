...
public class FunctionDemo {
  public static void main(String[] args) {
    ...
    Function<String, Character> fistCharFunc = str -> str.charAt(0);

    System.out.println(lengthFunc.apply("abc")); // 3
    System.out.println(fistCharFunc.apply("month")); // m
    ...
    // if there have value, it would replace old value
    ...
    // if there is null value, it would remove key

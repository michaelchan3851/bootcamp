public class Polymorphism {
  public static void main(String[] args) {
    ...
    Human customer2 = new Customer("Peter");
    customer2.order();
    ...
    order2.order(); // +3
    // because can't find customer which is vincent, and new
    // Driver(Customer.counter+3)
    System.out.println(Customer.counter); // 11 // 7+1+3
  }
